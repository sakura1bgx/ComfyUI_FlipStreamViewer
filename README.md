...
- **FlipStreamLoadChatModel**: Loads an LLM (Large Language Model) for chat. It only supports *.gguf files in the models/LLM folder and uses llama-cpp-python.
- **FlipStreamChat**: Obtains chat responses from the chat model.
